...
\EducationEntry{Just authentication for the internet}{2020}{PasswordsCon (a track on Internetdagarna)}{
  An introduction talk about my utopian side-project that proposes how we might solve authentication in a simple yet secure way.
}

\EducationEntry{The physiological aspects of ambiguity}{2019}{Copenhagen Ruby Brigade}{
  An interesting perspective on what ambiguity does to us physically, and how keeping context in mind when writing code, can reduce ambiguity leading to less anger and anxeity in the team.
}

\EducationEntry{Applied Event Sourcing, Domain Driven Design and CQRS}{2018}{Copenhagen Ruby Brigade}{
  A talk where I explain the basics of the concepts and how they are applied in the platform of Zetland.
}
